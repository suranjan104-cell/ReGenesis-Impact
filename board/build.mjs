...
slides.push(slide(`
  ...
  <div>
    <h1>From ledger<br>to <em style="font-style:italic;color:var(--emerald)">forecast</em></h1>
    <div style="height:28px"></div>
    <p class="lede" style="max-width:850px">
      Scenario analysis and transition planning ask for a different class of data than
      emissions accounting produces. This briefing sets out what the standards require,
      what supervisory exercises have already found, and where the first wave of
      reporters fell short.
    </p>
  </div>
  <div class="cover-meta">
    <div>
      <h4>In this briefing</h4>
      <p>{{EXCOUNT}} exhibits · ${SRC.length} sources · data as at ${CUTOFF}</p>
    </div>
    <div>
      <h4>Standards</h4>
      <p>IFRS S2 · AASB S2 · ISSA 5000 / ASSA 5010 · MAS ENRM</p>
    </div>
    <div>
      <h4>Evidence base</h4>
      <p>ECB · Bank of England · APRA · NGFS · ASIC</p>
    </div>
  </div>
